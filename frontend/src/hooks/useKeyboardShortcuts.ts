...
import type { SettingsTabId } from '../context/ModalContext';
...
interface ShortcutActions {
  ...
  editAgentByIndex: (index: number) => void;
}

export function useKeyboardShortcuts(actions: ShortcutActions, dependencies: any[]) {
  useEffect(() => {
