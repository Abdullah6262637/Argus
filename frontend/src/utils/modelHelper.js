 ...
 */
export function getModelLogo(model, provider) {
    ...
    if (p === 'gemini')
        return '/providers/gemini.png?v=3';
    if (p === 'googleaistudio')
        return '/providers/googleaistudio.png?v=3';
    if (p === 'openrouter')
        return '/providers/openrouter.png?v=3';
    if (p === 'groq')
        return '/providers/groq.png?v=3';
    if (p === 'deepseek')
        return '/providers/deepseek.png?v=3';
    if (p === 'mistral')
        return '/providers/mistral.png?v=3';
    if (p === 'xai')
        return '/providers/xai.png?v=3';
    if (p === 'sambanova')
        return '/providers/sambanova.png?v=3';
    if (p === 'cerebras')
        return '/providers/cerebras.png?v=3';
    if (p === 'fireworks')
        return '/providers/fireworks.png?v=3';
    if (p === 'together')
        return '/providers/together.png?v=3';
    if (p === 'local')
 ...
 */
export function getMcpLogo(serverName) {
    const name = serverName.toLowerCase();
    if (name.includes('github'))
        return '/mcp/github.png';
    if (name.includes('fetch'))
        return '/mcp/fetch.png';
    if (name.includes('sqlite'))
        return '/mcp/sqlite.png';
    if (name.includes('file') || name.includes('fs') || name.includes('dir'))
        return '/mcp/filesystem.png';
    if (name.includes('docker'))
        return '/mcp/docker.png';
    if (name.includes('postgres') || name.includes('pg'))
        return '/mcp/postgres.png';
    if (name.includes('slack'))
        return '/mcp/slack.png';
    if (name.includes('sentry'))
        return '/mcp/sentry.png';
    if (name.includes('aws'))
        return '/mcp/aws.png';
    if (name.includes('brave'))
        return '/mcp/brave-search.png';
    if (name.includes('puppeteer') || name.includes('playwright'))
        return '/mcp/puppeteer.png';
    if (name.includes('memory'))
        return '/mcp/memory.png';
    return '';
}
